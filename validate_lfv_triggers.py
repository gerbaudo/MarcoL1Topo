...
def main():
    ...
    for iEvent, event in enumerate(chain):
        ...
        list_0dr15, list_pairs = algo_0DR15(muons, n_mu) #0dr15 couplelist
        list_mu6_0dr15, list_mu6_pairs = algo_0DR15([muon for muon, Pt in list_mu6ab], n_mu6ab) #mu6_0dr15 couplelist

        pass_emul = len(list_mu6_0dr15) and n_mu6ab>1   #returns true if 2mu6ab and 0dr15
        ...
        fill_histos(histos[outcome], histos2[outcome], muons, list_mu6ab, list_0dr15,
                    list_pairs, list_mu6_0dr15, list_mu6_pairs) #fill histograms
...
def algo_0DR15(muons, n_mu): #retuns ordered list with any couple of muons satisfying 0DR15
    ...
    couples_0dr15 = [couple for couple in couples_any if couple[2]>0.05 and couple[2]<1.505] #take only 0dr15
...
def fill_histos(histos, histos2, muons, list_mu6ab, list_0dr15,
                list_pairs, list_mu6_0dr15, list_mu6_pairs): #fills histograms
    n_mu = len(muons)
    n_mu6= len(list_mu6ab)
    n_0dr15_pairs = len(list_0dr15)
    n_mu6_pairs = len(list_mu6_pairs)
    n_mu6_0dr15_pairs = len(list_mu6_0dr15)
    ...
    histos['n_pairs_mu6ab'    ].Fill(n_mu6*(n_mu6-1.)/2) #number of mu6 pairs
